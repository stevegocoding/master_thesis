...
\begin{itemize}
  ...
  \item Proposed a new data structure that maintians the kd-tree leaf nodes data and photons data for GPU-based photon mapping renderer and implemented the parallel contruction and incremental updating algorithm on this data structure allowing us to efficiently perform radiance estimation using photons. 
